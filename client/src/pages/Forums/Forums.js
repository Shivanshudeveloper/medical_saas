  ...
  constructor(props) {
    ...
    this.state = {
      forums: [
        {
          id: 1,
          title: "Introductions: Neo Therapists",
          posted: "Calvin",
        },
        {
          id: 2,
        ...
        },
        {
          id: 9,
          title:
            "Neo Therapists includes the ability to create a better of sites by using the multisite feature.",
          posted: "Harry",
        },
      ],
    };
                            ...
                            <div className="d-flex">
                              ...
                              <div className="flex-1 content ms-3">
                                ...
                                <p className="text-muted small mb-0 mt-2">
                                  Start working with Neo Therapists that can provide
