                        ...
                        <Row className="justify-content-center">
                            <Col sm={8}>
                                <div className="text-sm-start">
                                    <p className="mb-0">© {new Date().getFullYear()} Neo Therapists. Develop with <i className="mdi mdi-heart text-danger"></i> by <a href="https://themesbrand.com/" rel="noreferrer" target="_blank" className="text-reset">ThemesBrand</a>.</p>
                                </div>
                            </Col>
