                        ...
                        <Row>
                            <Col md="6" xs="12">
                                <div className="d-flex">
                                    ...
                                    <div className="flex-1">
                                        <h5 className="mt-0">How our <span className="text-primary">Neo Therapists</span> work ?</h5>
                            ...
                            <Col md="6" xs="12" className="mt-4 pt-2">
                                <div className="d-flex">
                                    <i><FeatherIcon icon="help-circle" className="fea icon-ex-md text-primary me-2 mt-1" /></i>
                                    <div className="flex-1">
                                        <h5 className="mt-0"> Is <span className="text-primary">Neo Therapists</span> safer to use with my account ?</h5>
