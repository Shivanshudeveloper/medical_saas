                        ...
                        <Row className="align-items-center">
                            ...
                            <Col lg={7} md={6} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="section-title ms-lg-5">
                                    ...
                                    <p className="text-muted">You can combine all the Neo Therapists templates into a single one, you can take a component from the Application theme and use it in the Website.</p>
                            ...
                            <Col lg={7} md={6}>
                                <div className="accordion" id="accordionExample">
                                    <AccordianCommon2
                                        ...
                                        question2="Do I need a designer to use Neo Therapists ?"
