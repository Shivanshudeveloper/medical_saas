...
router.post('/addproduct', (req, res) => {
    res.setHeader('Content-Type', 'application/json');
    const { title, price, displayImage, category, madein, gender, description, product } = req.body;
...
router.post('/updateproductmainstore', (req, res) => {
    const { title, price, category, madein, gender, description, productId } = req.body;
    MainStore_Model.findOneAndUpdate({ '_id': productId }, { title, price, category, madein, gender, description }, { useFindAndModify: false })
        .then(() => {
